...
public class multiplyDigits {
  ...
  private static Long largestProduct(BigInteger bigNumber, Integer numberDigits) {
    long product = 0, tempProduct = 0; // make sure the product can fit in the variable
    ...
    } // convert the big number into an array of individual digits
    for (index = 0; index <= digitArray.length - numberDigits; index++) {
      ...
      } // multiply the number of digits specified
    ...
    } // look at all digits in the big number
    return product;
  } // largestProduct()
